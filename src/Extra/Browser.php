...
class Browser extends \Clue\React\Buzz\Browser
{
    ...
    public function __construct(LoopInterface $loop, $proxy = null)
    {
        ...
        $this->messageFactory = new \Galdino\Proxy\Extra\HttpProtocol\MessageFactory();
        $this->transaction = new \Galdino\Proxy\Extra\HttpProtocol\Transaction(
            \Galdino\Proxy\Extra\HttpProtocol\Sender::createFromLoop($loop, $connector, $this->messageFactory),
            $this->messageFactory,
            $loop
        );
    ...
    public function get($url, array $headers = array())
    {
        return $this->send(
            $this->messageFactory
                ->request('GET', $url, $headers, '', $this->proxy)
        );
    }
